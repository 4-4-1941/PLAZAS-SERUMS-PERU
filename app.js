...
const cache=new Map(), esc=v=>String(v??"").replace(/[&<>"']/g,c=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[c]));
...
function match(r){const x=r.oficial_minsa||{},n=r.normalizado||{};return(!e.pro.value||x.profesion===e.pro.value)&&(!e.dep.value||(n.departamento||x.departamento)===e.dep.value)&&(!e.prov.value||x.provincia===e.prov.value)&&(!e.dist.value||x.distrito===e.dist.value);}
